...
-- Tiempo de generación: 04-03-2025 a las 09:56:27
...
--
-- Volcado de datos para la tabla `detalles_hermandades`
--

INSERT INTO `detalles_hermandades` (`id`, `hermandad_id`, `recorrido`, `nazarenos`, `banda`) VALUES
(1, 1, 'Calle Nueva', 714, 'si'),
(2, 1, 'Calle Nueva', 714, 'si'),
(3, 1, 'Calle Nueva', 714, 'si'),
(4, 1, 'Calle Nueva', 714, 'si'),
(5, 1, 'Calle Zayas', 852, 'Banda Amueci');
